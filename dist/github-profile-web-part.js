...
var styles = {
    ...
    row: 'row_2998bff7',
    column: 'column_2998bff7',
    'ms-Grid': 'ms-Grid_2998bff7',
    title: 'title_2998bff7',
    subTitle: 'subTitle_2998bff7',
    description: 'description_2998bff7',
    button: 'button_2998bff7',
    label: 'label_2998bff7',
};
            ...
            external__react_["createElement"]("div", { className: GithubProfile_module_scss.container },
                external__react_["createElement"]("div", { className: GithubProfile_module_scss.row },
                    external__react_["createElement"]("div", { className: GithubProfile_module_scss.column },
                        ...
                        external__react_["createElement"]("p", { className: GithubProfile_module_scss.subTitle }, "Github repositories created"),
                        external__react_["createElement"]("p", { className: GithubProfile_module_scss.description },
                            this.state.loading ? external__react_["createElement"]("span", null, "Loading...") :
                                this.state.repos ? this.state.repos.filter(function (repo) { return !repo.isForked; }).map(function (repo) { return external__react_["createElement"]("span", { key: ++repoCounter, id: "repo" + repoCounter },
                                    Object(sp_lodash_subset_["escape"])(repo.repoName),
                                    " ",
                                    external__react_["createElement"]("br", null)); }) : external__react_["createElement"]("span", null, "None"),
                            !this.state.loading ? external__react_["createElement"]("span", { id: 'forkCount' },
                                external__react_["createElement"]("br", null),
                                "Additionally, ",
                                this.state.fullName,
                                " has forked ",
                                this.state.repos.filter(function (repo) { return repo.isForked; }).length,
                                " repositories") : null),
                        external__react_["createElement"]("p", { className: GithubProfile_module_scss.subTitle }, "Revent Github events"),
                        external__react_["createElement"]("p", { className: GithubProfile_module_scss.description }, this.state.loading ? external__react_["createElement"]("span", null, "Loading...") :
                            this.state.events ? this.state.events.map(function (event) { return external__react_["createElement"]("span", { key: ++eventCounter, id: "event" + eventCounter },
...
// CONCATENATED MODULE: ./lib/integration/GithubAPIProvider.js
    ...
    GithubProfileWebPart.prototype.getPropertyPaneConfiguration = function () {
        return {
            pages: [
                {
                    header: {
                        description: external__GithubProfileWebPartStrings_["PropertyPaneDescription"]
                    },
                    groups: [
                        {
...
// module
exports.push([module.i, ".githubProfile_2998bff7 .container_2998bff7{max-width:700px;margin:0 auto;box-shadow:0 2px 4px 0 rgba(0,0,0,.2),0 25px 50px 0 rgba(0,0,0,.1)}.githubProfile_2998bff7 .row_2998bff7{margin:0 -8px;box-sizing:border-box;color:\"[theme:white, default: #ffffff]\";background-color:\"[theme:themeDark, default: #005a9e]\";padding:20px}.githubProfile_2998bff7 .row_2998bff7:after,.githubProfile_2998bff7 .row_2998bff7:before{display:table;content:\"\";line-height:0}.githubProfile_2998bff7 .row_2998bff7:after{clear:both}.githubProfile_2998bff7 .column_2998bff7{position:relative;min-height:1px;padding-left:8px;padding-right:8px;box-sizing:border-box}[dir=ltr] .githubProfile_2998bff7 .column_2998bff7{float:left}[dir=rtl] .githubProfile_2998bff7 .column_2998bff7{float:right}.githubProfile_2998bff7 .column_2998bff7 .ms-Grid_2998bff7{padding:0}@media (min-width:640px){.githubProfile_2998bff7 .column_2998bff7{width:83.33333333333334%}}@media (min-width:1024px){.githubProfile_2998bff7 .column_2998bff7{width:66.66666666666666%}}@media (min-width:1024px){[dir=ltr] .githubProfile_2998bff7 .column_2998bff7{left:16.66667%}[dir=rtl] .githubProfile_2998bff7 .column_2998bff7{right:16.66667%}}@media (min-width:640px){[dir=ltr] .githubProfile_2998bff7 .column_2998bff7{left:8.33333%}[dir=rtl] .githubProfile_2998bff7 .column_2998bff7{right:8.33333%}}.githubProfile_2998bff7 .title_2998bff7{font-size:21px;font-weight:100;color:\"[theme:white, default: #ffffff]\"}.githubProfile_2998bff7 .subTitle_2998bff7{font-size:17px;font-weight:300;color:\"[theme:white, default: #ffffff]\"}.githubProfile_2998bff7 .description_2998bff7{font-size:12px;font-weight:400;color:\"[theme:white, default: #ffffff]\"}.githubProfile_2998bff7 .button_2998bff7{text-decoration:none;height:32px;min-width:80px;background-color:\"[theme:themePrimary, default: #0078d4]\";border-color:\"[theme:themePrimary, default: #0078d4]\";color:\"[theme:white, default: #ffffff]\";outline:transparent;position:relative;font-family:Segoe UI WestEuropean,Segoe UI,-apple-system,BlinkMacSystemFont,Roboto,Helvetica Neue,sans-serif;-webkit-font-smoothing:antialiased;font-size:14px;font-weight:400;border-width:0;text-align:center;cursor:pointer;display:inline-block;padding:0 16px}.githubProfile_2998bff7 .button_2998bff7 .label_2998bff7{font-weight:600;font-size:14px;height:32px;line-height:32px;margin:0 4px;vertical-align:top;display:inline-block}", ""]);
...
/***/ })
/******/ ])});;
//# sourceMappingURL=github-profile-web-part.js.map