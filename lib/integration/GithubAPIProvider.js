...
var GithubAPIProvider = (function () {
    ...
    GithubAPIProvider.prototype.CommitHistory = function (githubUser) {
        return new Promise(function (resolve, reject) {
            axios.get('https://api.github.com/users/' + githubUser + '/events').then(function (response) {
    ...
    GithubAPIProvider.prototype.ReposForUser = function (githubUser) {
        return new Promise(function (resolve, reject) {
            axios.get('https://api.github.com/users/' + githubUser + '/repos').then(function (response) {
